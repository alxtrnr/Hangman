...
def hangman(test_word=None):
    ...
    # create random word
    if not test_word:
        word = list(wordnik_service.get_random_word(hasDictionaryDef="true", maxLength=11))
    else:
        word = test_word
...
def player_go(*args):
    ...
    while answer != word_copy:
        ...
        if guess not in word:
            ...
            # removes the first instance so if there are more of them they can be found. This means if a guessed
